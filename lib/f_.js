...
function augment(toAugment, config){
  ...
  // Will hold our f_ methods and properties, so we can later assign in
  ...
  // If we're dealing with functions / classes, assign f_ stuff to prototype
  if(toAugmentType === 'function') toAugment.prototype = f_holder;
  // If we're dealing with a plain object, we assign f_ stuf to the object
