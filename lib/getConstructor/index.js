...
// @TODO module f_Constructor!
//var Constructor = process.ROOT_REQUIRE('./lib/Err');
...
module.exports = function getConstructor(con_o) {
   ...
   * @TODO Module this, split split! HAVE IT TAKE "custom_object" in order
   * to allow for data passage on 'new' (initialization).
   * @constructor
  ...
  function f_Constructor(ins_o) {
    ...
    // Sanitize instance_options
    ins_o.custom_data = ins_o.custom_data || undefined;
