...
var f_methods = {
	...
	next: function next(){
		...
		// Are we done with functionFlow? If yes finish, else continue
	 ...
	 * Will be further edited to allow deeper object namespace keeping
	 */
	...
	finish: function finish(){
		...
		if(this.f_toLog.has('finish'))
			log(GREEN('finish') + '  time taken: ' + GREEN(this.f_timeTaken) + ' ms');
